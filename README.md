...
<h3><code>⚡ SOC Analyst in Training & Bio</code></h3>
<ul>
<li><b>[+] Target Role:</b> Junior / Entry-Level SOC Analyst (Tier 1)</li>
<li><b>[+] Core Focus:</b> Log Analysis, Network Monitoring, Threat Detection & SIEM Basics</li>
<li><b>[+] Current Progress:</b> Hands-on practice via CTF, TryHackMe, and defense labs</li>
<li><b>[+] Mindset:</b> <i>"Detect early, analyze deeply, respond effectively."</i></li>
</ul>

<hr/>

<h3><code>🛡️ SOC & Defense Arsenal (Tools & Skills)</code></h3>
<p>
...
```bash
$ soc-analyst@kikiaimar:~# monitor --status
> [ACTIVE] Monitoring logs, learning defense tactics, securing the perimeter.
